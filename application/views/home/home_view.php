<div class="wrapper">
    <div class="parallax filter-gradient blue" data-color="blue">
        <div class="parallax-background">
            <img class="parallax-background-image" src="<?=base_url()?>public/img/home.png">
        </div>
        <div class= "container">
            <div class="row">
                <div class="col-md-5 hidden-xs">
                    <div class="parallax-image">
                        <img class="phone" src="<?=base_url()?>public/img/template/iphone3.png" style="margin-top: 20px"/>
                    </div>
                </div>
                <div class="col-md-6 col-md-offset-1">
                    <div class="description">
                        <h2>Hi, I'm Diego Sánchez</h2>
                        <br>
        ...
        <div class="container text-center">
            ...
            <div class="logos">
                <ul class="list-unstyled">
                    <li ><img src="<?=base_url()?>public/img/logos/adobe.png"/></li>
                    <li ><img src="<?=base_url()?>public/img/logos/zendesk.png"/></li>
                    <li ><img src="<?=base_url()?>public/img/logos/ebay.png"/></li>
                    <li ><img src="<?=base_url()?>public/img/logos/evernote.png"/></li>
                    <li ><img src="<?=base_url()?>public/img/logos/airbnb.png"/></li>
                    <li ><img src="<?=base_url()?>public/img/logos/zappos.png"/></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-1 hidden-xs">
                    <img src="<?=base_url()?>public/img/template/mac.png"/>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-6">
                    <div id="description-carousel" class="carousel fade" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="item">
                                <img src="<?=base_url()?>public/img/template/examples/home_33.jpg" alt="">
                            </div>
                            <div class="item active">
                                <img src="<?=base_url()?>public/img/template/examples/home_22.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="<?=base_url()?>public/img/template/examples/home_11.jpg" alt="">
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div id="carousel-example-generic" class="carousel fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item">
                        <div class="mask">
                            <img src="<?=base_url()?>public/img/faces/face-4.jpg">
                        </div>
                    ...
                    <div class="item active">
                        <div class="mask">
                            <img src="<?=base_url()?>public/img/faces/face-3.jpg">
                        </div>
                        <div class="carousel-testimonial-caption">
                            <p>Drake, Artist</p>
                    ...
                    <div class="item">
                        <div class="mask">
                            <img src="<?=base_url()?>public/img/faces/face-2.jpg">
                        </div>
                        <div class="carousel-testimonial-caption">
    ...
    <div class="section section-no-padding">
        <div class="parallax filter-gradient blue" data-color="blue">
            <div class="parallax-background">
                <img class ="parallax-background-image" src="<?=base_url()?>public/img/template/bg3.jpg"/>
            </div>
            <div class="info">
